...
!function(e,t){"use strict";var n=e.navigator.userAgent.toLowerCase();if(/trident/gi.test(n)||/msie/gi.test(n)){for(var r,a=t.querySelectorAll("use"),i=0;i<a.length;i++)r="#"+(r=a[i].getAttribute("xlink:href")).split("#")[1],a[i].setAttribute("xlink:href",r);if(!t.createElementNS||!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var o,l,s="localStorage"in e&&null!==e.localStorage,g=function(){t.body.insertAdjacentHTML("afterbegin",l)},c=function(){t.body?g():t.addEventListener("DOMContentLoaded",g)};if(s&&8==localStorage.getItem("inlineSVGrev")&&(l=localStorage.getItem("inlineSVGdata")))return c();try{(o=new XMLHttpRequest).open("GET","img/svg/symbol/sprite.svg",!0),o.onload=function(){200<=o.status&&o.status<400&&(l=o.responseText,c(),s&&(localStorage.setItem("inlineSVGdata",l),localStorage.setItem("inlineSVGrev",8)))},o.send()}catch(e){}}}(window,document);
$(document).ready(function(){var i=window.navigator.userAgent.toLowerCase();if(/trident/gi.test(i)||/msie/gi.test(i)){document.createElement("picture"),$(".field").css("padding-top","9px"),$(".cart__weight").css("width","130px"),$(".cart__price").css("width","70px");var t=$(".social__icon");t.css({position:"relative",left:"0.5px"});var e=$(".social__link"),s=!1;t.on("mousedown",function(){$(this).css({fill:"rgba(255, 255, 255, 0.5)"}),s=!0}),$("html").on("mousemove",function(){s=!1}),e.on("mouseout",function(){$(this).children().css("fill","rgba(255, 255, 255, 0.8)"),s=!1}),t.on("mousemove",function(){s||$(this).css("fill","rgba(255, 255, 255, 1)")}),$(".range__field").css("padding","2px 5px 9px")}});
...
$(document).ready(function(){var o=$(".slider__list");o.slick({dots:!0,arrows:!1,infinite:!0,speed:300,slidesToShow:1});var n=["#849d8f","#8996a6","#9d8b84"];o.on("afterChange",function(o,e,a){$("body").css("background-color",n[a])});var e=new Popup({popup:".modal__popup",closeModal:".modal__popup-close",overlay:".modal__overlay"});$(".feedback__button").on("click",function(o){o.preventDefault(),e.open($(".modal__write"))})});